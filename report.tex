...
La suddivisione del lavoro in moduli interconnessi ha presentato la necessit\`a
di poter verificare e persistere il funzionamento del codice sin dai primi giorni
di sviluppo: a tal fine si fa uso della funzione ausiliaria \verb!Nostd::test! e
del comando \verb!make test! per compilare ed eseguire tutti i file di \emph{unit testing}.
