/*
  ...
  strict_box.cpp: Implements a version of Box which allows the consumer to focefully
  define absolute maximum dimentions, withing which the children must fit
*/
...
Engine::UI::Box::dim Engine::UI::StrictBox::size(szu max_width, szu max_height) {
