...
wchar_t* Nostd::WString::c_str() const {
  return v;
}
wchar_t* Nostd::WString::data() const {
  return v;
}
size_t Nostd::WString::length() const {
  return sz - 1;
}
size_t Nostd::WString::max_size() const {
  return SIZE_MAX;
}
...
const wchar_t& Nostd::WString::back() const {
  return v[sz - 2];
}
...
Nostd::WString& Nostd::WString::insert(size_t start,
...
int Nostd::WString::compare(size_t start,
                            size_t len,
